...
const baseStyles = "px-8 py-2 rounded-xl border-2 font-bold transition-all duration-200 outline-none disabled:opacity-40 disabled:cursor-not-allowed disabled:border-transparent";
